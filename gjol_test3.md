...
整篇建议的格局，分为三部分。其中第一部分为基本问题，也就是一些和具体系统企划关系不大，主要和外在表现有关的问题。第二部分为深入修改，也就是一些会涉及到系统企划修改，更为深入的问题。第三部分为其他杂项，算是一些简单的小问题汇总吧。<br>
...
*  **建议：** 没啥好说的，还是建议 **大量缩小御剑各个技能的动作前摇** ，让御剑也能拥有和天罡一样，没有啥迟滞感的手感。实际上不仅仅是御剑，**所有职业技能企划虽都有不同，但希望都能往天罡的手感方向靠拢**，让我们都能感受一下那种畅快随性的手感，而不是只能眼巴巴地看着流口水。说真的，现在天罡和其他职业的手感差距，基本上就是古二中初七和夷则的手感差距，你们可以脑补下画面。<br>
...
*  **建议：** 其实就是建议 **重新设计御剑的普通攻击动作，让每一段普通攻击动作都有比较大的差异**，这样玩家就可以从攻击动作上直观判断出我现在技能已经循环到第几段了。现在三测的普通攻击动作，每一段之间虽然也有差异，但差异实在太小，在战局中用余光观测还是有些困难。
...
*  **建议：** 主要的修改方向是，按照上面的原则，通用技能应该是一些偶尔突发状况下才会使用的技能，而不是一些经常会使用的技能，所以建议保留那些回血，减伤，解控的技能，而 **去掉那些大幅增大攻击力的，持续回蓝，以及让敌方虚弱的技能。这些技能，实际上可以转移到奶妈职业的身上**，让她们不单单身兼回血重任，还肩负着全队的buff控制，来控制队伍的输出节奏。同理，一些灵器的主动增益技能也可以被取消掉，换成被动增益之类的效果。<br>
...
其中 **左右键的攻击负责生成幻剑**，当满足精准连击，或者右键满蓄力时等一定条件时，身边会自动生成幻剑，并浮动在身旁，跟随人物移动，像浮游炮一样（可以参考鬼泣中维吉尔的幻影剑，之前一测二测幻剑漂浮在身边的样子太绵软无力）。同时自动填充一格剑意，也就是说有几格剑意，也代表着有几把幻剑。<br>
